...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ADD HENTAI TO YOUR GROUP ➕️", url="t.me/Hentai_robot?startgroup=true"),
    ],
    [
    ...
    [
        ...
        InlineKeyboardButton(
            text="👥 SUPPORT", url="https://t.me/hentai_support"
        ),
    ],
]
...
def Masha_about_callback(update, context):
    ...
    if query.data == "masha_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Hentai*, a powerful group management bot built to help you manage your group easily, and u can use me in fight.
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *HENTAI*
                 \nHere is the [Source Code](https://github.com/theshashankk/hentaiRobot) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
